...
const Appointment = () => {
  ...
  const bookAppointment = async()=>{
    ...
    try{
      ...
      let month = date.getMonth()+1 //+1 becoz it will give 1 for the january
  ...
  return docInfo && (   //important *docInfo && -> info doctor information will be there then only it will show this doctor details 
    <div>
      {/* { ---------Doctors Details -------} */}
    ...
    <button onClick={bookAppointment}   className='bg-primary text-white text-sm font-light px-14 py-3 rounded-full my-6'>Book a Appointment</button>
    </div>
