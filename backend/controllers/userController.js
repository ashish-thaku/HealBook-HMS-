...
const paymentRazorpay = async (req, res) => {
    ...
    // Creating option razorpay payment 
        const options = {
            ...
            currency: process.env.CURRENCY, //Razorpay expects lowercase currency only when creating orders.
...
const verifyRazorpay = async(req,res)=>{
    try{
        ...
        if(orderInfo.status === 'paid'){
            await appointmentModel.findByIdAndUpdate(orderInfo.receipt, {payment:true})    //we need appointmentId so we use 'orderInfo.receipt'
